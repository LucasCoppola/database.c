...
static const char *keywords[] = {
    KEYWORD_CREATE, KEYWORD_DROP,    KEYWORD_TABLE, KEYWORD_SELECT,
    KEYWORD_INSERT, KEYWORD_DELETE,  KEYWORD_FROM,  KEYWORD_INTO,
    KEYWORD_VALUES, KEYWORD_WHERE,

    KEYWORD_INT,    KEYWORD_INTEGER, KEYWORD_REAL,  KEYWORD_TEXT,
    KEYWORD_BOOL,   KEYWORD_BOOLEAN};
