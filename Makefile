...
TEST_CREATE_TABLE = $(TESTS_DIR)/test_core/test_create_table.c  
...
test_create_table: $(TEST_CREATE_TABLE) $(TEST_UTILS) $(CORE_FILES) $(STORAGE_FILES) $(PARSER_FILES) $(TOKENIZER_FILES) $(PARSER_STATEMENTS_FILES) $(HASHMAP_FILES) $(UTILS_FILES)
